...
export declare const updateOptionsSchema: {
    ...
    upsert: <T extends ObjectType<any>>(attributesSchema: T) => import("@kbn/config-schema").Type<Readonly<{ [K in keyof ("error" | "version" | "namespaces" | "updatedAt" | "createdAt" | "originId" | "managed" | "createdBy" | "updatedBy" | (undefined extends import("@kbn/config-schema").TypeOf<T> ? "attributes" : never) extends infer T_1 extends keyof {
        id: import("@kbn/config-schema").Type<string>;
        type: import("@kbn/config-schema").Type<string>;
        version: import("@kbn/config-schema").Type<string | undefined>;
        createdAt: import("@kbn/config-schema").Type<string | undefined>;
