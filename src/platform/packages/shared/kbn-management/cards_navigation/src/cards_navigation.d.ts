...
export declare const getAppIdsByCategory: (category: string, appDefinitions: AggregatedCardNavDefinitions) => ("spaces" | "transform" | "settings" | "objects" | "tags" | "roles" | "dataViews" | "ingest_pipelines" | "pipelines" | "index_management" | "jobsListLink" | "filesManagement" | "reporting" | "triggersActionsConnectors" | "triggersActions" | "maintenanceWindows" | "api_keys" | "data_quality" | "data_usage" | "content_connectors")[];
