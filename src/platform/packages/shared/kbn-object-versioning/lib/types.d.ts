...
export interface VersionableObject<UpIn = unknown, UpOut = unknown, DownIn = unknown, DownOut = unknown> {
    schema?: Type<any>;
...
export interface ObjectTransforms<UpIn = unknown, UpOut = unknown, DownIn = unknown, DownOut = unknown> {
    up: <I = UpIn, O = UpOut>(obj: I, version?: Version | 'latest', options?: {
        /** Validate the object _before_ up transform */
        validate?: boolean;
    }) => TransformReturn<O>;
    down: <I = DownIn, O = DownOut>(obj: I, version?: Version | 'latest', options?: {
