...
export declare function ManagedFlyout({ exportIntegration, intl, isDirty, onCloseFlyout, publicAPIEnabled, shareObjectTypeMeta, shareObjectType, shareObjectTypeAlias, onSave, isSaving, sharingData, }: ManagedFlyoutProps): React.JSX.Element;
