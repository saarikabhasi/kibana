import type { ShareContext, ShareConfigs, ShareRegistryPublicApi, ShareActionIntents, ShareIntegration, ShareRegistryApiStart, ShareMenuProviderLegacy, RegisterShareIntegrationArgs } from '../types';
export declare class ShareRegistry implements ShareRegistryPublicApi {
    ...
    setup(): {
        ...
        registerShareIntegration: <I extends ShareIntegration>(...args: [string, RegisterShareIntegrationArgs<I>] | [RegisterShareIntegrationArgs<I>]) => void;
    };
