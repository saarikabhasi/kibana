 ...
 */
export type ShareIntegration<IntegrationParameters extends Record<string, unknown> = Record<string, unknown>> = ShareImplementationFactory<'integration', IntegrationParameters>;
/**
 ...
 */
export interface ExportShare extends ShareIntegration<{
    /**
 ...
 */
export interface ExportShareDerivatives extends ShareIntegration<{
    label: React.FC<{
        openFlyout: () => void;
    }>;
...
export interface RegisterShareIntegrationArgs<I extends ShareIntegration = ShareIntegration> extends Pick<I, 'id' | 'groupId' | 'prerequisiteCheck'> {
