...
export declare class TaskPollingLifecycle implements ITaskEventEmitter<TaskLifecycleEvent> {
     ...
     * mechanism.
     */
    constructor({ basePathService, logger, middleware, config, elasticsearchAndSOAvailability$, taskStore, definitions, executionContext, usageCounter, taskPartitioner, startingCapacity, }: TaskPollingLifecycleOpts);
