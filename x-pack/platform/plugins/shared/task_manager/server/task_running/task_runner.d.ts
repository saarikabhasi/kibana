...
import type { CancelFunction, ConcreteTaskInstance, FailedRunResult, IntervalSchedule, PartialConcreteTaskInstance, RruleSchedule, SuccessfulRunResult, TaskDefinition } from '../task';
...
export declare class TaskManagerRunner implements TaskRunner {
     ...
     */
    constructor({ basePathService, instance, definitions, logger, store, beforeRun, beforeMarkRunning, defaultMaxAttempts, onTaskEvent, executionContext, usageCounter, config, allowReadingInvalidState, strategy, getPollInterval, }: Opts);
    /**
    ...
    cancel(): Promise<void | ({
        ...
        taskRunError?: import("./errors").DecoratedError;
